...
<head>
    <meta charset="UTF-8">
    <title>KUITANSI OTR - {{ $kontrol->no_kwitansi_otr }}</title>
    <style>
        ...
        .title-main { font-size: 14px; font-weight: bold; text-align: center; text-decoration: underline; letter-spacing: 2px; }
...
<body onload="window.print()">
            ...
            <td class="header-meta">
                <table>
                    <tr>
                        ...
                        <td><b>{{ $kontrol->no_kwitansi_otr }}</b></td>
                    </tr>
                    <tr>
                        <td>No. SJ</td>
                        <td>:</td>
                    ...
                    <tr>
                        <td>Tanggal</td>
                        <td>:</td>
                        <td>{{ \Carbon\Carbon::parse($kontrol->tgl_kwitansi_otr)->format('d/m/Y') }}</td>
                    </tr>
                </table>
            </td>
        </tr>
    ...
    <table class="content-table">
        ...
        <tr>
            ...
            <td>:</td>
            <td>
                <div>Rp {{ number_format($spk->harga_otr, 0, ',', '.') }}</div>
            </td>
        </tr>
        <tr>
            <td>Terbilang</td>
            ...
            <td class="font-bold" style="font-style: italic; background-color: #f5f5f5; padding: 6px;">
                {{ ucwords(\Terbilang::make($spk->harga_otr)) }} Rupiah
            </td>
        </tr>
        <tr>
            <td>Keterangan</td>
            <td>:</td>
            <td class="font-bold uppercase">HARGA PEMBELIAN SEPEDA MOTOR HONDA (GP)</td>
        </tr>
        <tr>
            <td>Tipe</td>
            <td>:</td>
    ...
    <div class="signature-container">
        <div class="signature-row">
            ...
            <div class="signature-cell signature-right">
                Garut, {{ \Carbon\Carbon::parse($kontrol->tgl_kwitansi_otr)->translatedFormat('d F Y') }}<br>
                Hormat Kami,<br>
