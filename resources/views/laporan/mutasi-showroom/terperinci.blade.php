...
<div class="max-w-[95rem] mx-auto">
    <div class="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
            <h2 class="text-2xl font-extrabold text-gray-900 flex items-center gap-3">
                ...
                Laporan Terperinci Mutasi Ke Showroom
            </h2>
            <p class="text-sm text-gray-500 mt-1 ml-4">Rincian fisik unit motor yang dimutasi ke Showroom Pusat.</p>
        </div>
        <a href="{{ route('laporan.mutasi-showroom.print-terperinci', ['dari_tanggal' => $dari_tanggal, 'sampai_tanggal' => $sampai_tanggal]) }}" target="_blank" class="bg-gray-800 text-white font-bold py-2.5 px-6 rounded-lg shadow-md hover:bg-gray-900 transition-all flex items-center gap-2">
    ...
    <div class="bg-white p-4 rounded-2xl border border-gray-100 shadow-sm mb-6 flex flex-col lg:flex-row justify-between items-center gap-4">
        <form action="{{ route('laporan.mutasi-showroom.terperinci') }}" method="GET" class="w-full flex flex-col sm:flex-row items-center gap-3">
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left border-collapse whitespace-nowrap">
                ...
                <tbody class="text-sm">
                    ...
                    @empty
                        <tr>
                            <td colspan="9" class="py-8 text-center text-gray-500 italic border-b border-gray-100">Tidak ada rincian mutasi unit ke Showroom pada periode ini.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
