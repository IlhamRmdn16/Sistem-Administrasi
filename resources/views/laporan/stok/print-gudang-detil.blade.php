...
<head>
    <meta charset="UTF-8">
    <title>Laporan Stok Gudang Detil</title>
    <style>
...
<body onload="window.print()">
    <div class="header">
        <h2>Laporan Stok Gudang Detil (Tersedia)</h2>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th style="width: 10%;">Lokasi Gudang</th>
                <th style="width: 10%;">No. Kunci</th>
                <th>Tipe Motor</th>
                <th style="width: 14%;">Warna</th>
                <th style="width: 6%;">Tahun</th>
                <th style="width: 18%;">No. Mesin</th>
                <th style="width: 20%;">No. Rangka</th>
            </tr>
        </thead>
        <tbody>
            @forelse($units as $index => $unit)
                <tr>
                    ...
                    <td class="text-center font-bold uppercase">{{ $unit->posisi_stok }}</td>
            ...
            @empty
                <tr><td colspan="8" class="text-center">Tidak ada data unit di gudang.</td></tr>
            @endforelse
        </tbody>
    </table>
</body>
