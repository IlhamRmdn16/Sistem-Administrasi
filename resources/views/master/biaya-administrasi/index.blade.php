            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden sticky top-6">
                <div class="px-5 py-4 border-b border-gray-100 bg-slate-50">
                    <h3 class="font-bold text-gray-800 flex items-center gap-2">
                        <svg class="w-5 h-5 text-honda-red" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <form @submit.prevent="submitCreate" class="space-y-4">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1.5">
                                Kategori Biaya Sistem
                            </label>

                            <select
                                name="kode_sistem"
                                x-model="createKodeSistem"
                                class="w-full border border-gray-300 focus:border-honda-red focus:ring-4 focus:ring-red-50 rounded-lg shadow-sm py-2.5 px-4 outline-none transition-all text-gray-800 text-sm bg-white"
                            >
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1.5">
                                Keterangan Biaya <span class="text-red-500">*</span>
                            </label>

                            <input
                                type="text"
                                name="keterangan"
                                x-model="createKeterangan"
                                :readonly="createKodeSistem !== ''"
                                :required="createKodeSistem === ''"
                                placeholder="Contoh: Biaya Plat Nomor"
                                class="w-full border border-gray-300 focus:border-honda-red focus:ring-4 focus:ring-red-50 rounded-lg shadow-sm py-2.5 px-4 outline-none transition-all text-gray-800 text-sm readonly:bg-gray-100 readonly:text-gray-500"
                            >
                        </div>

                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1.5">
                                Nilai Biaya (Rp) <span class="text-red-500">*</span>
                            </label>
                            ...
                            <div class="relative">
                                ...
                                <input
                                    ...
                                    required
                                    min="0"
                                    class="w-full border border-gray-300 focus:border-honda-red focus:ring-4 focus:ring-red-50 rounded-lg shadow-sm py-2.5 pl-11 pr-4 outline-none transition-all text-gray-800 font-mono text-sm"
                                >
                            </div>
                        </div>
                        ...
                        <div class="pt-2">
                            <button
                                type="submit"
                                class="w-full bg-honda-red text-white font-bold py-2.5 px-4 rounded-lg shadow-md hover:bg-red-700 transition-all flex items-center justify-center gap-2"
                                ...
                                <tr class="hover:bg-slate-50/50 transition-colors">
                                    ...
                                    <td class="py-3 px-5">
                                        <div class="flex items-center justify-center gap-3">
                                            ...
                                            <button
                                                type="button"
                                                onclick="confirmDeleteAjax({{ $b->id }}, this)"
                    ...
                    <form @submit.prevent="submitEdit" class="space-y-4">
                        ...
                        <div>
                            ...
                            <select
                                name="kode_sistem"
                                x-model="eKodeSistem"
                                class="w-full border border-gray-300 focus:border-blue-500 focus:ring-4 focus:ring-blue-50 rounded-lg shadow-sm py-2.5 px-4 outline-none transition-all text-gray-800 text-sm bg-white"
                            >
                                <option value="">Bebas / Lain-lain</option>
                                <option value="ADM">Biaya ADM Pengajuan</option>
                                <option value="TB_STNK">Tanda Bayar STNK</option>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                name="keterangan"
                                x-model="eKeterangan"
                                :readonly="eKodeSistem !== ''"
                                :required="eKodeSistem === ''"
                                class="w-full border border-gray-300 focus:border-blue-500 focus:ring-4 focus:ring-blue-50 rounded-lg shadow-sm py-2.5 px-4 outline-none transition-all text-gray-800 text-sm readonly:bg-gray-100 readonly:text-gray-500"
                            >
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input
                                    ...
                                    required
                                    min="0"
                                    class="w-full border border-gray-300 focus:border-blue-500 focus:ring-4 focus:ring-blue-50 rounded-lg shadow-sm py-2.5 pl-11 pr-4 outline-none transition-all text-gray-800 font-mono text-sm"
                                >
                            </div>
                        </div>
                        ...
                        <div class="flex justify-end gap-3 pt-4 mt-2 border-t border-gray-100">
                            ...
                            <button
                                type="button"
                                @click="isEditModalOpen = false"
                                class="px-5 py-2.5 bg-white border border-gray-300 rounded-lg font-bold text-gray-700 hover:bg-gray-50 text-sm"
                                :disabled="isEditing"
                            >
                                Batal
                            </button>
                            ...
                            <button
                                type="submit"
                                class="px-5 py-2.5 bg-blue-600 text-white rounded-lg font-bold shadow hover:bg-blue-700 flex items-center gap-2 text-sm"
                                :disabled="isEditing"
                            >
...
function biayaManager() {
    return {
        ...
        init() {
            this.$watch('createKodeSistem', value => {
                this.createKeterangan = value;
            });

            this.$watch('eKodeSistem', value => {
                this.eKeterangan = value;
            });
        },
