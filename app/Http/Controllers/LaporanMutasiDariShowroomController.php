...
class LaporanMutasiDariShowroomController extends Controller
{
    public function global(Request $request)
    {
        ...
        $data = MutasiDetail::join('mutasis', 'mutasi_details.mutasi_id', '=', 'mutasis.id')
            ...
            ->where('mutasis.lokasi_asal', 'Showroom Pusat')
        ...
        return view('laporan.mutasi-dari-showroom.global', compact('data', 'dari_tanggal', 'sampai_tanggal', 'total_unit'));
    }
    ...
    public function printGlobal(Request $request)
    {
        ...
        return view('laporan.mutasi-dari-showroom.print-global', compact('data', 'dari_tanggal', 'sampai_tanggal', 'total_unit'));
    }
    ...
    public function terperinci(Request $request)
    {
        ...
        // Menambahkan with('tujuanPop') untuk mengetahui tujuan mutasinya
        $data = Mutasi::with(['details.motorUnit.type', 'details.motorUnit.color', 'tujuanPop'])
            ->where('lokasi_asal', 'Showroom Pusat')
        ...
        return view('laporan.mutasi-dari-showroom.terperinci', compact('data', 'dari_tanggal', 'sampai_tanggal', 'per_page'));
    }
    ...
    public function printTerperinci(Request $request)
    {
        ...
        return view('laporan.mutasi-dari-showroom.print-terperinci', compact('data', 'dari_tanggal', 'sampai_tanggal'));
    }
}
