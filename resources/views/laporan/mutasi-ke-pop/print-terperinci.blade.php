...
<head>
    ...
    <title>Print Terperinci Mutasi Ke POP</title>
    <style>
...
<body onload="window.print(); setTimeout(window.close, 500);">
    <div class="header">
        <h2>LAPORAN TERPERINCI MUTASI KE POP / SALES</h2>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th style="width: 140px;">TUJUAN POP / SALES</th>
        ...
        <tbody>
            ...
            @forelse($data as $mutasi)
                ...
                <tr>
                    @if($subIndex === 0)
                        ...
                        <td rowspan="{{ $totalUnits }}" class="font-bold">{{ $mutasi->tujuanPop->nama_sales ?? 'Tidak Diketahui' }}</td>
                    @endif
            ...
            @empty
                <tr>
                    <td colspan="9" class="text-center italic">Tidak ada data mutasi ke POP pada periode ini.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
