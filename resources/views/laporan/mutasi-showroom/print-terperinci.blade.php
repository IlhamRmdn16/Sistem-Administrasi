...
<head>
    ...
    <title>Print Terperinci Mutasi Ke Showroom</title>
    <style>
...
<body onload="window.print(); setTimeout(window.close, 500);">
    <div class="header">
        <h2>LAPORAN TERPERINCI MUTASI KE SHOWROOM PUSAT</h2>
    ...
    <table>
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="9" class="text-center italic">Tidak ada data mutasi ke Showroom pada periode ini.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
