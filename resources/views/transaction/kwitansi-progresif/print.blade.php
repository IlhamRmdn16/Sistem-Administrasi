...
<head>
    ...
    <style>
        ...
        body { font-family: 'Arial', sans-serif; font-size: 12px; margin: 0; padding: 0; color: #000; line-height: 1.4; }
        ...
        .title { text-align: center; font-size: 16px; font-weight: bold; text-decoration: underline; margin-bottom: 15px; letter-spacing: 1px;}
        .kwitansi-no { text-align: center; font-size: 12px; margin-top: -10px; margin-bottom: 20px; font-weight: bold; }
...
<body onload="window.print()">
    ...
    <div class="nominal-box">
        Terbilang Rp {{ number_format($samsat->pajak_progresif, 0, ',', '.') }},-
    </div>
