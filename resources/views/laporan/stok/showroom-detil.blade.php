...
<div class="max-w-7xl mx-auto">
    ...
    <div class="bg-white p-4 rounded-2xl border border-gray-100 shadow-sm mb-6 flex flex-col sm:flex-row justify-between items-center gap-4">
        <form action="{{ route('laporan.stok.showroom-detil') }}" method="GET" class="w-full flex flex-col sm:flex-row items-center gap-3">
            ...
            <table class="w-full text-left border-collapse">
                <thead class="bg-honda-red text-white text-[11px] uppercase tracking-wider">
                    <tr>
                        ...
                        <th class="py-4 px-4 bg-gray-900">No. Rangka</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-gray-100 text-xs">
                    @forelse($units as $index => $unit)
                        <tr class="hover:bg-slate-50 transition-colors">
                            ...
                            <td class="py-3 px-4 font-mono font-bold text-emerald-700 border-r border-gray-100 uppercase">{{ $unit->no_mesin }}</td>
