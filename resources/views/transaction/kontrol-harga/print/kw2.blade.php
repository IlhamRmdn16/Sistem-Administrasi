...
<head>
    <meta charset="UTF-8">
    <title>KUITANSI SUBSIDI - {{ $kontrol->no_kwitansi_kw2 }}</title>
    <style>
...
<body onload="window.print()">
    ...
    @php
        ...
        // Perbaikan variabel menjadi $tgl_kw2
        $tgl_kw2 = \Carbon\Carbon::parse($kontrol->tgl_kwitansi_kw2);
        $tanggalIndo = $tgl_kw2->format('d') . ' ' . $bulanIndo[$tgl_kw2->month] . ' ' . $tgl_kw2->format('Y');
        ...
        // Perbaikan pengecekan kondisi agar mengecek keterangan_penagihan_2
        $keterangan = !empty($spk->leasing->keterangan_penagihan_2) ? $spk->leasing->keterangan_penagihan_2 : 'PEMBAYARAN SUBSIDI LEASING';
    @endphp
            ...
            <td class="header-meta">
                <table>
                    <tr>
                        ...
                        <td><b>{{ $kontrol->no_kwitansi_kw2 }}</b></td>
                    </tr>
                    <tr>
                        <td>No. SJ</td>
                        <td>:</td>
    ...
    <table class="content-table">
        ...
        <tr>
            ...
            <td>:</td>
            <td>
                <span class="amount-text">Rp {{ number_format($kontrol->dll_2, 0, ',', '.') }},-</span>
            </td>
        </tr>
        <tr>
            <td>Terbilang</td>
            ...
            <td class="font-bold" style="font-style: italic; background-color: #f5f5f5; padding: 6px;">
                {{ ucwords(\Terbilang::make($kontrol->dll_2)) }} Rupiah
            </td>
        </tr>
        <tr>
            <td>Keterangan</td>
