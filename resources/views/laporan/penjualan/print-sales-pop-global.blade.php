...
<head>
    <meta charset="UTF-8">
    <title>Cetak Laporan Penjualan Sales POP Global</title>
    <style>
        ...
        td { padding: 5px 6px; }
        tr.sales-row td { font-weight: bold; text-transform: uppercase; font-size: 11px; padding-top: 14px; padding-bottom: 8px; color: #222; }
...
<body onload="window.print()">
    <div class="header">
        <h2>Laporan Penjualan Sales / POP - Global</h2>
    ...
    <table>
        ...
        <tbody>
            ...
            @forelse($reports as $salesName => $items)
                ...
                @endforeach
                <tr class="sub-total">
                    <td colspan="2" class="text-right uppercase">Sub Total {{ $salesName }} :</td>
