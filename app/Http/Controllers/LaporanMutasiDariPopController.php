...
class LaporanMutasiDariPopController extends Controller
{
    private $kolomFkPop = 'lokasi_asal_pop_id'; 
    ...
    public function global(Request $request)
    {
        ...
        return view('laporan.mutasi-dari-pop.global', compact('data', 'dari_tanggal', 'sampai_tanggal', 'total_unit', 'pops', 'pop_id'));
    }
    ...
    public function printGlobal(Request $request)
    {
        ...
        return view('laporan.mutasi-dari-pop.print-global', compact('data', 'dari_tanggal', 'sampai_tanggal', 'total_unit', 'nama_pop_filter'));
    }
    ...
    public function terperinci(Request $request)
    {
        ...
        $query = Mutasi::with(['details.motorUnit.type', 'details.motorUnit.color', 'asalPop'])
            ->where('lokasi_asal', 'POP')
        ...
        return view('laporan.mutasi-dari-pop.terperinci', compact('data', 'dari_tanggal', 'sampai_tanggal', 'per_page', 'pops', 'pop_id'));
    }

    public function printTailored(Request $request)
    {
        $dari_tanggal = $request->input('dari_tanggal');
        $sampai_tanggal = $request->input('sampai_tanggal');
        $pop_id = $request->input('pop_id', 'semua');
        ...
        return view('laporan.mutasi-dari-pop.print-terperinci', compact('data', 'dari_tanggal', 'sampai_tanggal', 'nama_pop_filter'));
    }
}
