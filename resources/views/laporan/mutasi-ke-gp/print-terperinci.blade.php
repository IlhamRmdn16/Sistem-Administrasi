...
<head>
    ...
    <title>Print Terperinci - {{ $judul }}</title>
    <style>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th style="width: 120px;">LOKASI ASAL</th>
        ...
        <tbody>
            ...
            @forelse($data as $mutasi)
                ...
                <tr>
                    @if($subIndex === 0)
                        ...
                        <td class="font-bold" rowspan="{{ $totalUnits }}">
            ...
            @empty
                <tr>
                    <td colspan="9" class="text-center italic">Tidak ada data mutasi ke Showroom GP pada periode ini.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
